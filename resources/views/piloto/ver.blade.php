...
<head>
    <meta charset="UTF-8">
    <title>Infinity Bingo - Piloto de Prueba</title>
    ...
    <style>
/* =========================================================
   ESTÉTICA ROLLS-ROYCE OLED | VISTA DEL JUGADOR (PILOTO)
========================================================= */
body { 
    background: #020202; 
...
.bingo-empty { background: rgba(255,255,255,0.05); border: 1px dashed rgba(255,255,255,0.1); box-shadow: none; border-radius: 6px; aspect-ratio: 1; }
...
@php
    ...
    $streamUrl = trim($jugada->streaming_url ?? '') ?: null; 
    ...
    <div class="piloto-grid-top">
        ...
        <div class="glass-panel p-1">
            <div class="tv-container" id="video-container">
                ...
                <div class="tv-waiting-overlay" id="tvWaiting" style="position: absolute; inset: 0; background: rgba(0,0,0,0.6); z-index: 5; display: flex; flex-direction: column; align-items: center; justify-content: center; border-radius: 12px; transition: opacity 0.5s;">
                ...
                <div id="bluff-video-container" style="position: absolute; inset: 0; z-index: 2; opacity: 0; pointer-events: none; transition: opacity 0.5s; overflow: hidden; border-radius: 12px;">
